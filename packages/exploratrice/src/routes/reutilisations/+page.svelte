...
<div class="container mx-auto max-w-7xl px-4 py-8">
    ...
    <div class="flex items-start justify-between gap-4">
      <div class="flex-1">
        ...
        <p class="text-lg text-muted-foreground">
          Découvrez les services et applications qui utilisent les données
          Tricoteuses, ainsi que nos démonstrations de ce qu'il est possible de
          construire.
        </p>
      </div>
  ...
  {#if filteredReuses.length === 0}
    <div class="py-12 text-center">
      <p class="text-lg text-muted-foreground">
        Aucune réutilisation trouvée pour ce filtre.
      </p>
    </div>
  {/if}
</div>
