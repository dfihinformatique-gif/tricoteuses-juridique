...
import {
  ...
  computeCroppedHash,
  getCroppedBase64Src,
} from "$lib/server/alineas/alineas_images_utils.js"

// Configuration
const DEFAULT_DOCUMENTS_PATH = "../../../assemblee-data/Documents"
    ...
    for (const img of images) {
      ...
      if (!imageDataByHash.has(img.hash)) {
        ...
        imageDataByHash.set(img.hash, {
          ...
          croppedHash: computeCroppedHash(img.base64Src),
          croppedBase64Src: getCroppedBase64Src(img.base64Src),
        })
      }
        ...
        for (const [hash, occurrences] of occurrencesByHash) {
          if (!allImages[hash]) {
            ...
            allImages[hash] = {
              ...
              croppedHash: imgData.croppedHash,
              croppedBase64Src: imgData.croppedBase64Src,
              occurrences: [],
            }
          }
